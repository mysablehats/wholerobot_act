...
class ControlHead:
    def __init__(self):
        ...
        rospy.init_node('headtracking_node', log_level=rospy.DEBUG)
        #print('hello')
        ...
        self.velfiltersize = 20 # TODO: param
        self.velfilterlx = []
        self.velfilterly = []
        ...
        self.posfiltersize = 20 # TODO: param
        self.posfilterlx = []
        self.posfilterly = []
        ...
        nocontrolzonex = 0.1#0133333333333
        nocontrolzoney = 0.1#0133333333333
        ...
        increase_in_angle_of_ptu_pan_to_get_from_middle_to_extreme_right = min([1.2/theratenum, 0.2]) ### needs to be measured. changing the rate changes this!
        increase_in_angle_of_ptu_tilt_to_get_from_middle_to_extreme_bottom = min([0.8/theratenum, 0.2]) ### needs to be measured
    ...
    def docontrol(self):
        if self.HA:
            ...
            self.velx = np.mean(self.velfilterlx)
            self.vely = np.mean(self.velfilterly)
            rospy.logdebug("vel after mean: {}, {}".format(self.velx, self.vely))
