...
from face_recognition_ros.msg import HeadsFloat,HeadsArrayFloat
import numpy as np
...
class find_faces:
  ...
  def __init__(self):
    ...
    self.heads_pub = rospy.Publisher('heads', HeadsArrayFloat, queue_size=1)
